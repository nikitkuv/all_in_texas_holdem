...
#defining a function to calculate combination for each player and rank them all
def results_counter(list_input):
    """
    :param list_input (list of tuples: [(card name (str), card suit (str), card nominal (int)), ...] - list of player's cards):
    :return result (list: [points (int), combination name (str), nominals of remaining cards (list of int)], in this script assigned to round_results variable):
    """
...
def winner_list(round_results:list):
    """
    :param round_results (return of results_counter function defined above):
    :return sorted_list (list of lists of lists: innermost list - element of input parameter, "middle" list - set of equally scored players, elements here are sorted according combinations):
    """
